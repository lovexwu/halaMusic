...
var Footer={
  ...
  render:function(){
    var _this = this
    $.getJSON('http://jirenguapi.applinzi.com/fm/v2/getChannels.php')
      .done(function(ret){
        console.log(ret)
...
var Fm={
  ...
  loadMusic:function(){
    var _this = this
    $.getJSON('http://jirenguapi.applinzi.com/fm/v2/getSong.php',{channel:this.channelId})
    .done(function(ret){
  ...
  loadLyric:function(){
    var _this = this
    $.getJSON('http://jirenguapi.applinzi.com/fm/v2/getLyric.php',{sid:this.song.sid})
    .done(function(ret){
      var lyric = ret.lyric
      var lyricObj = {}
      var arr = lyric.split('\n')
